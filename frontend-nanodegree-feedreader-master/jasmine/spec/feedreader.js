...
$(function () {
     ...
     */
    describe('RSS Feeds exsist', function () {
         ...
         */
        it('URL for each feed has somnething', () => {
         ...
         */
        it('Feed Name to be  Defined and not be zero ', () => {
            allFeeds.forEach((feed) => {
    ...
    describe('Initial Entries', () => {
        ...
        it(" at least a single .entry within  .feed exsists/after loadFeed() is called", ((done) => {
